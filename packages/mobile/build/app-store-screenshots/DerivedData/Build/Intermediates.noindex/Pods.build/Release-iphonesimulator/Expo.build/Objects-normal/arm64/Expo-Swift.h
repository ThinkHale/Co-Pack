...
+ (void)setCustomURLSessionConfigurationProvider:(NSURLSessionConfiguration * _Nullable (^ _Nullable)(void))provider;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol RCTReactNativeFactoryDelegate;
SWIFT_CLASS("_TtC4Expo22ExpoReactNativeFactory")
@interface ExpoReactNativeFactory : EXReactNativeFactory
