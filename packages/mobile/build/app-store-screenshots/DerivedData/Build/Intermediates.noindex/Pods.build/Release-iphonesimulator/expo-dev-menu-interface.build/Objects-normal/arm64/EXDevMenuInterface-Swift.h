...
SWIFT_PROTOCOL("_TtP18EXDevMenuInterface19DevMenuHostDelegate_")
@protocol DevMenuHostDelegate <NSObject>
@optional
...
/// Defaults to <code>true</code> if not implemented.
- (BOOL)devMenuShouldShowReactNativeDevMenu SWIFT_WARN_UNUSED_RESULT;
@end
