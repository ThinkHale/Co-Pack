...
SWIFT_CLASS("_TtC13EXDevLauncher26DevLauncherDevMenuDelegate")
@interface DevLauncherDevMenuDelegate : NSObject <DevMenuHostDelegate>
@property (nonatomic, weak) EXDevLauncherController * _Nullable controller;
...
@class NSURL;
SWIFT_CLASS_NAMED("DevLauncherNetworkInterceptor")
@interface EXDevLauncherNetworkInterceptor : NSObject
- (nonnull instancetype)initWithBundleUrl:(NSURL * _Nonnull)bundleUrl OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC13EXDevLauncher25DevLauncherViewController")
@interface DevLauncherViewController : UIViewController
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
- (void)resetHostingController;
...
+ (UIUserInterfaceStyle)exportManifestUserInterfaceStyle:(NSString * _Nullable)userInterfaceStyle SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)appWasOpened:(NSString * _Nonnull)url queryParams:(NSDictionary<NSString *, NSString *> * _Nonnull)queryParams manifest:(EXManifestsManifest * _Nullable)manifest;
- (NSArray<NSDictionary<NSString *, id> *> * _Nonnull)recentlyOpenedApps SWIFT_WARN_UNUSED_RESULT;
- (NSDictionary<NSString *, id> * _Nullable)mostRecentApp SWIFT_WARN_UNUSED_RESULT;
- (void)clearRegistry;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (NSURL * _Nonnull)bundleURL:(NSURL * _Nonnull)bundleURL withResolvedPlatform:(NSString * _Nonnull)platform SWIFT_WARN_UNUSED_RESULT;
...
@class UIApplication;
SWIFT_RESILIENT_CLASS("_TtC13EXDevLauncher36ExpoDevLauncherAppDelegateSubscriber")
...
@class UIView;
SWIFT_RESILIENT_CLASS("_TtC13EXDevLauncher35ExpoDevLauncherReactDelegateHandler")
@interface ExpoDevLauncherReactDelegateHandler : EXReactDelegateHandler <EXDevLauncherControllerDelegate>
...
- (BOOL)isReactInstanceValid SWIFT_WARN_UNUSED_RESULT;
