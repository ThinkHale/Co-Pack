...
SWIFT_CLASS("_TtC18EXUpdatesInterface25UpdatesControllerRegistry")
@interface UpdatesControllerRegistry : NSObject
...
@class NSURL;
@class NSUUID;
@protocol EXUpdatesStateChangeListener;
@protocol EXUpdatesStateChangeSubscription;
/// All updates controllers implement this protocol, which provides information on the running
/// updates system.
SWIFT_PROTOCOL_NAMED("UpdatesInterface")
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nullable requestHeaders;
@property (nonatomic, readonly, copy) NSUUID * _Nullable launchedUpdateId;
@property (nonatomic, readonly, copy) NSUUID * _Nullable embeddedUpdateId;
@property (nonatomic, readonly, copy) NSString * _Nullable launchAssetPath;
- (id <EXUpdatesStateChangeSubscription> _Nonnull)subscribeToUpdatesStateChanges:(id <EXUpdatesStateChangeListener> _Nonnull)listener SWIFT_WARN_UNUSED_RESULT;
@end

@protocol EXUpdatesExternalInterfaceDelegate;
/// Implemented only by the dev client updates controller.
SWIFT_PROTOCOL_NAMED("UpdatesDevLauncherInterface")
@protocol EXUpdatesDevLauncherInterface <EXUpdatesInterface>
...
SWIFT_PROTOCOL_NAMED("UpdatesStateChangeListener")
@protocol EXUpdatesStateChangeListener
- (void)updatesStateDidChange:(NSDictionary<NSString *, id> * _Nonnull)event;
@end

SWIFT_PROTOCOL_NAMED("UpdatesStateChangeSubscription")
@protocol EXUpdatesStateChangeSubscription
- (void)remove;
- (id _Nullable)getContext SWIFT_WARN_UNUSED_RESULT;
@end
