            ...
            return (
              <Pressable
                ...
                style={({ pressed }) => [
                  ...
                  selected && { borderColor: profile.palette, backgroundColor: colors.blueSoft },
...
const styles = StyleSheet.create({
  ...
  hireText: { color: colors.ink, fontSize: 11, fontWeight: '900' },
  stripFrame: { flex: 1 },
  ...
  chip: {
    ...
    borderRadius: radius.sm,
    borderWidth: 1.5,
    borderColor: 'rgba(22,139,234,0.20)',
    paddingHorizontal: 7,
    paddingVertical: 4,
  },
